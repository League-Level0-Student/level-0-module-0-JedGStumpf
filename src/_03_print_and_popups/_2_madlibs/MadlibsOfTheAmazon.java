...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
		...
		String liquid = JOptionPane.showInputDialog(null, "Please enter an liquid");

		// Get the player to enter a body part
		String bodyPart = JOptionPane.showInputDialog(null, "Please enter an body part");
		// Get the player to enter a verb
		String verb = JOptionPane.showInputDialog(null, "Please enter an verb");
		// Get the player to enter a place
		String place = JOptionPane.showInputDialog(null, "Please enter an place");
